...
потом в основном запросе уже джойнит из таблиц нужные поля, но с условием
уникальности по customer_id, потому что покупатели в свой первый день делали
по нескольк покупок товаров с ценой 0*/
